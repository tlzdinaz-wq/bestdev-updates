if gameVersion == 'fivem' and GetConvarInt('voice_enableSubmix', 1) == 1 and GetConvarInt("voice_enableAudioOcclusion", 1) == 1 then
    ...
    SetAudioSubmixEffectParamFloat(audioOcclusionSubmix, 0, `freq_hi`, 1850.0)
    ...
    SetAudioSubmixEffectParamFloat(audioOcclusionSubmix, 0, `o_freq_hi`, 1850.0)
    ...
    CreateThread(function()
        ...
        while true do
            ...
            if audioOcclusionEnabled then
                ...
                if #players > 1 then
                    for playerIndex, playerId in ipairs(players) do
                        local otherPlayer = GetPlayerPed(playerId)

                        if player ~= otherPlayer then
                            local needToCheck, distance = addProximityCheck(playerId)
