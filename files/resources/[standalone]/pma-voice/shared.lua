...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		...
		{4.0, "Parler"}, -- Normal speech distance in gta distance units
		{7.5, "Parler fort"}, -- Loud speech distance in gta distance units
		{12.5, "Crier"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "Chuchoter"}, -- Whisper speech distance in gta distance units
		{8.0, "Parler"}, -- Normal speech distance in gta distance units
		{15.0, "Parler fort"}, -- Loud speech distance in gta distance units
		{25.0, "Crier"} -- Shout speech distance in gta distance units
	}
end
